...
cl = LINETCR.LINE()
cl.login(token="EqsnUjilyOZPoMZG8qG1.Vm537HvN52AR3XEMBzrY8q.GU9yXyep9mlWHVtWNEj5KTXxkcLWDhGCRmv98/gw/4Y=")
cl.loginResult()
...
targets = []
mid = cl.getProfile().mid
Bots = ["ubcce77ee1567e766abdf17a66d9472f1","ua0a448a1719f1649b0d9fa0343d0a5e0",Amid1]
self = ["ubcce77ee1567e766abdf17a66d9472f1","ua0a448a1719f1649b0d9fa0343d0a5e0",Amid1]
...
wait = {
    ...
    'message':"Thanks for add Me By:™🇹🇭✾แมวเป้✍Գန້さັএπັஞ🇹🇭➢",
    "lang":"JP",
...
#-----------------------------------------------
                ...
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,"🇨🇦ลบร้นเสดแล้ว🇹🇭")
                else:
...
#========================================
            ...
            elif "Pea2:" in msg.text:
                c = msg.text.replace("Pea2:","")
                if c in [""," ","\n",None]:
                    cl.sendText(msg.to,"เกิดข้อผิดพลาด..!!")
                else:
                    wait["bcomment"] = c
...
#=============================================
                ...
                cl.sendText(msg.to,"🇹🇭เปิดแทคเสดแล้ว🇹🇭")
                
            elif msg.text in ["ปิดแทค"]:
                wait["detectMention"] = False
                cl.sendText(msg.to,"🇹🇭ปิดแทคเสดแล้ว🇹🇭")
                ...
                cl.sendText(msg.to,"🍁ข้อความแทคล่าสุดคือ🇹🇭\n\n" + str(wait["tag2"]))
                    ...
                    wait["tag1"] = msg.text.replace("pop1: ","")
                    cl.sendText(msg.to,"ข้อความแทคล่าสุดคือ")

            elif "pop2:" in msg.text:
                    wait["tag2"] = msg.text.replace("pop2: ","")
                    cl.sendText(msg.to,"ข้อความแทคล่าสุดคือ")
