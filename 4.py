...
cl =LINETCR.LINE()
#cl.login(qr=True)
cl.login(token='EpacLppiBzaggkEkt6d8.6S7B6iV24SxpyyIZPkjUga.+4vthLNsl93EBJPTRaf3nOt2ffWakmKxhPFFhlU0gYc=')
cl.loginResult()

ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='EpyzhKg0UNjs5X991Bx9.Z2jqcI8fppmz+7xOGNlyEq.5FDZGg+QtTL/aiuagAA2YRr2+snznZzq6nrHYJ0sJjI=')
ki.loginResult()

ki2 = LINETCR.LINE()
#ki2.login(qr=True)
ki2.login(token='EpjT6tPkTcCwUwMm7wRa.Ql+Iq95c4olkmxSaoadLoG.2djnisCidK3KpySxFKPdqhNvSF25ZaAWsDbnSSnaTKw=')
ki2.loginResult()

ki3 = LINETCR.LINE()
#ki3.login(qr=True)
ki3.login(token='EpmTfnaD958sDkPtvCj6.SGby4XQI1gAOTET1lBqQ9G.bXpheBATXWfgKQnVdoXTPJ81FQ1Rg17ftEfSbNamaNw=')
ki3.loginResult()

ki4 = LINETCR.LINE()
#ki4.login(qr=True)
ki4.login(token='EpuSQOrE3OoEJWHfMCha.Q6+YE7DHLRb+4/UXmbKggG.ig5JezXVGBz8T7CvFwCPhjOVr6LdCJWhwRscAgLrMBc=')
ki4.loginResult()

ki5 = LINETCR.LINE()
#ki5.login(qr=True)
ki5.login(token='EpmQgZ0IkIbZdzrUkeJ8.7fLTCfOW6V77bikOdoT16a.DL2tvHzhlMHFo4EPUKYi29bwzxyxQfxSJce4w/x8pyU=')
ki5.loginResult()
cl
